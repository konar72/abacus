...
_TL;DR: pen and paper is simply refreshing in an increasingly digital (and artificially intelligent) world. The irony of digitizing this is not lost on me. This is my tiny droplet-sized contribution into the vast sea of habit trackers and organizers. If it helps you, then I'm happy. 
_
...
![Crude version one of my habit tracker](/assets/v1.png) v1
...
![A more refined V2](/assets/v2.png) v2
